...
public abstract class ItemsList {
    protected ItemsList rightLink = null;
    protected ItemsList leftLink = null;
    protected Object value;

    public ItemsList(Object value) {
        this.value = value;
    }

    abstract ItemsList nextItem();
    abstract ItemsList setNextItem(ItemsList item);


    abstract ItemsList previousItem();
    abstract ItemsList setPreviousItem(ItemsList item);

    abstract int compareTo(ItemsList item);
